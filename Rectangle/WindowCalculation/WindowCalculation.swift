...
class WindowCalculationFactory {
    ...
    static let calculationsByAction: [WindowAction: WindowCalculation] = [
     ...
     .maxResizeUp: directionalResizeCalculation,
     .maxResizeDown: directionalResizeCalculation,
     .maxResizeLeft: directionalResizeCalculation,
     .maxResizeRight: directionalResizeCalculation,
